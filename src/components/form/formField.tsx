    ...
    <>
      {isTextHolder ? (
        <div className="flex flex-col my-3 flex-1">
          ...
          <div className="flex border border-gray-300 font-sans font-normal text-gray-800 rounded-xl px-3 py-2 my-2 text-sm outline-none focus-within:ring-secondary focus-within:ring-2 focus-within:ring-offset-2 transition duration-75 ease-out">
            <input
              type={fieldType}
              name={id}
              id={id}
        ...
        <div className="flex flex-col my-3 flex-1">
          ...
          <input
            ...
            onChange={onChangeFunc}
            required={isRequired}
            className="border border-gray-300 rounded-md font-sans font-normal text-gray-800 px-3 py-2 my-2 text-sm focus:outline-secondary focus:outline-2 focus:outline-offset-2 duration-75 ease-out"
          />
          {showMessage &&
            (isSuccess ? (
              <p className="mt-2 text-sm text-green-600 dark:text-green-500">{msgSuccess}</p>
